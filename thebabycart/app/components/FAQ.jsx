...
const FAQ = () => {
  return (
    <div>
      <div>
        <h2 className="heading-6 mb-5">Frequently asked questions</h2>
      </div>
      <div className="accordion accordion-flush" id="accordionExample">
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body caption">
        ...
        <div className="accordion-item">
          <h2 className="accordion-header">
            ...
            >
              4. Are there any additional fees or taxes applied after order confirmation?
            </button>
          </h2>
          <div
            id="collapseFour"
